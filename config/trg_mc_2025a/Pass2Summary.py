...
for task in tasks.keys():
    ...
    query = "files where merge.tag=%s-pass2_v2 and core.run_type='fardet-hd' and dune.output_status=confirmed and core.data_tier='root-tuple' and dune.campaign=trg_mc_2025a_tpg and merge.dataset='%s'"%(task,parent_dataset)
